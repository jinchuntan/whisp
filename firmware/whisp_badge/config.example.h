// ===========================================================================
// Whisp badge configuration — TEMPLATE.
//
...
// ---- Whisp API base URL (no trailing slash) ----
...
// ---- Prototype API key (sent as X-Whisp-Key) ----
...
// validation: paste the server's root CA PEM into WHISP_ROOT_CA below.
//
...
//
// #define WHISP_INSECURE_TLS 1

// Root CA (PEM). Leave empty to rely on WHISP_INSECURE_TLS for https.
#define WHISP_ROOT_CA ""
