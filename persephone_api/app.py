"""FastAPI application factory for the Persephone web/API control plane.
...
from persephone_api import __version__
from persephone_api.config import get_settings
from persephone_api.models import API_PREFIX
from persephone_api.routes import admin, auth, badge, health, questions

logging.basicConfig(
    level=os.environ.get("LOG_LEVEL", "INFO"),
    format="%(asctime)s %(levelname)s %(name)s %(message)s",
)
log = logging.getLogger("persephone.app")
